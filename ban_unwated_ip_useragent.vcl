### Include this file in varnish default config.
...
sub vcl_recv {
				...
				error 403 "You seem to be blocked man.";}

											 if (req.http.user-agent ~ "^Pixray"
											 ||	req.http.user-agent ~ "^$"
											 ...
											 {
				error 403 "If you think This is Mistake Please use different User-Agent..";}
			}
